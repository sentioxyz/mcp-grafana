...
- ClickHouse: Execute SQL queries against ClickHouse datasources for log data with automatic time range filtering. List databases/tables and retrieve table schemas.
